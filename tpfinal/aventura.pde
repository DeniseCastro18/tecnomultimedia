class Aventura {
  ...
  void dibujar () {
    println(juego.estado+" estado juego");
   println( juego.B.bx);
    println( Pr.salvado[0]+ "1");
        println( Pr.salvado[1]+ "2");
            println( Pr.salvado[2]+ "3");
    if (estado.equals("presentacion")) {
      ...
      T.textosC(20, 0, 3, width/40, height-20);
       ...
       if (Pr.salvado[1]==true && Pr.salvado[2]==true&& Pr.salvado[0]) {
      estado="final2";
    }
      delay=delay+1; 
      P.dibujarFondo(2);
